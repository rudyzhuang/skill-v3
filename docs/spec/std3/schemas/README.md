...
| [prd-web.json.schema.json](prd-web.json.schema.json) | `docs/prd-web.json` |
| [prd-backend.json.schema.json](prd-backend.json.schema.json) | `docs/prd-backend.json` |
| [prd-mobile.json.schema.json](prd-mobile.json.schema.json) | `docs/prd-mobile.json` |
| [prd-admin.json.schema.json](prd-admin.json.schema.json) | `docs/prd-admin.json` |
| [prd-default.json.schema.json](prd-default.json.schema.json) | 未知端 `docs/prd-*.json` |
