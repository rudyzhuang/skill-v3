...
- [1. stage 实现规范（人话版）](#1-stage-实现规范人话版)
  - [setup](#setup-stage-setup)
  - [prd](#prdcjs-stage-prd)
  - [prd-review](#prd-reviewcjs-stage-prd-review)
  - [design](#designcjs-stage-design)
  - [design-review](#design-reviewcjs-stage-design-review)
  - [create-ui-scenarios](#create-ui-scenarioscjs-stage-create-ui-scenarios)
  - [codegen](#codegencjs-stage-codegen)
  - [code-review](#code-reviewcjs-stage-code-review)
  - [merge_push](#merge_pushcjs-stage-merge_push)
  - [build](#buildcjs-stage-build)
  - [deploy](#deploycjs-stage-deploy)
  - [smoke](#smokecjs-stage-smoke)
  - [ui_e2e](#ui_e2ecjs-stage-ui_e2e)
  - [report](#reportcjs-stage-report)
- [2. 门闸链汇总](#2-门闸链汇总)
- [3. `run-pipeline.cjs` 编排映射](#3-run-pipelinecjs-编排映射)
- [4. Agent 卡点速查](#4-agent-卡点速查)
- [5. prompts 文件清单（待建）](#5-prompts-文件清单待建)
- [6. 附录：模板文件内容](#6-附录模板文件内容)
  - [req-template.md](#req-templatemd)
  - [config.env.template](#configenvtemplate)
  - [config.json.template](#configjsontemplate)
  - [stages.json.template](#stagesjsontemplate)
  - [prd-spec.md.template](#prd-specmdtemplate)
  - [prd-<client_target>.json.template](#prd-client_targetjsontemplate)
...
- [9. 附录：JSON Schema 文件](#9-附录json-schema-文件)
  - [stop.signal.schema.json](#stopsignalschemajson)
  - [stages.json.schema.json](#stagesjsonschemajson)
  - [config.json.schema.json](#configjsonschemajson)
  - [prd-client.base.schema.json](#prd-clientbaseschemajson)
  - [prd-web.json.schema.json](#prd-webjsonschemajson)
  - [prd-backend.json.schema.json](#prd-backendjsonschemajson)
  - [prd-mobile.json.schema.json](#prd-mobilejsonschemajson)
  - [prd-admin.json.schema.json](#prd-adminjsonschemajson)
  - [prd-default.json.schema.json](#prd-defaultjsonschemajson)
  - [prd-review-client-output.schema.json](#prd-review-client-outputschemajson)
  - [prd-review-output.schema.json](#prd-review-outputschemajson)
  - [design.json.schema.json](#designjsonschemajson)
  - [design-review-feature-output.schema.json](#design-review-feature-outputschemajson)
