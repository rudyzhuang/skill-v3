...
import { handleCreateProject } from '../../handlers/v1/create-project';
...
import { pipelineV1 } from './pipeline';
...
projectsV1.post('/', handleCreateProject);

projectsV1.route('/', pipelineV1);
