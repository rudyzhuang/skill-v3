...
if (args['code-review-json'] || process.env.AI_STD3_CODE_REVIEW_JSON) {
  process.stdout.write('[WARN] --code-review-json / AI_STD3_CODE_REVIEW_JSON 已弃用，忽略。\n');
}
...
function generateSummaryReport({ features, featureResults, decision, criticalIssuesTotal, warningsTotal }) {
  ...
  md += `---\n\n*由 ai-std3 code-review stage 自动生成（${checkedAt}）*\n`;
  return md;
}
