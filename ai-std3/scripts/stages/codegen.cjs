...
function spawnWorker(featureId, attemptIndex, stagesObj, config) {
  const workerScriptPath = path.join(skillsRoot, 'ai-std3', 'scripts', 'libs', 'codegen-worker.cjs');
  ...
  const env = Object.assign({}, process.env, {
    AI_STD3_PROJECT:       projectRoot,
    AI_STD3_FEATURE_ID:    featureId,
    AI_STD3_ATTEMPT_INDEX: String(attemptIndex),
    AI_STD3_RUN_ID:        runId,
    AI_STD3_AGENT_ID:      agentId,
