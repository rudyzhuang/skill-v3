...
function buildScenarioVars(config, baseUrl) {
  const envUser = process.env.UI_E2E_TEST_USER || process.env.AI_STD4_UI_E2E_TEST_USER || '';
  const envPass = process.env.UI_E2E_TEST_PASSWORD || process.env.AI_STD4_UI_E2E_TEST_PASSWORD || '';
